    ...
    Box (
        ...
        Column(
            ...
            Row(
                ...
                Image(painter = painterResource(Res.drawable.facebook), modifier = Modifier
                    .size(45.dp)
                    .clickable { }, contentDescription = "facebook logo"
                )
                Image(painter = painterResource(Res.drawable.twitter), modifier = Modifier
                    .size(45.dp)
                    .clickable { }, contentDescription = "twitter logo"
                )
                Image(painter = painterResource( Res.drawable.google), modifier = Modifier
                    .size(45.dp)
